          ...
          <div class="col-lg-6">
            ...
            <form class="needs-validation" action method="POST" novalidate>
              <fieldset class="form-group">
                ...
                <input value="<?php echo $name; ?>" type="text" class="form-control" name="name" id="name" placeholder="Tytuł">
                <small class="form-text text-muted">Opcjonalne</small>
              </fieldset>
              <fieldset class="form-group">
                <label for="week">Miesiąc</label>
                <input value="<?php echo $week; ?>" type="text" class="form-control" name="week" id="week" placeholder="Miesiąc">
              </fieldset>
              <fieldset class="form-group">
                <label for="video">Film</label>
                <input value="<?php echo $video; ?>" type="text" class="form-control" id="video" name="video" placeholder="Film">
              </fieldset>
              <fieldset class="form-group">
            ...
            <?php else:
              ...
              $sql = $db->prepare("UPDATE videos SET name=?, week=?, video=?, content=? WHERE id=?");
              $sql->bind_param('ssssd', $name, $week, $video, $content, $id);
              $sql->execute();
